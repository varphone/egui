...
use crate::{
    ArcPieShape, CircleShape, Color32, ColorMode, CubicBezierShape, EllipseShape, Mesh, PathShape,
...
pub fn adjust_colors(
    ...
    match shape {
        ...
        Shape::ArcPie(ArcPieShape {
            ...
            match &mut stroke.color {
                color::ColorMode::Solid(col) => adjust_color(col),
